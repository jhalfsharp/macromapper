    ...
    pub fn to_camera(&self) -> Camera2D {
        Camera2D {
            ...
            zoom: vec2(
                ...
                -self.scale * 2.0 / self.screen_rect.h, //Why the fuck did macroquad flip the y-axis?
                                                        //TODO: maybe rewrite anything that's flipped? I haven't touched rendering code in a while
            ),
            viewport: Some((
